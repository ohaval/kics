...
var (
	openAPIRegex                                    = regexp.MustCompile(`"?(openapi|swagger)"?\s*:`)
	openAPIRegexInfo                                = regexp.MustCompile(`"?info"?\s*:`)
	openAPIRegexPath                                = regexp.MustCompile(`"?(paths|components|webhooks)"?\s*:`)
	armRegexContentVersion                          = regexp.MustCompile(`"contentVersion"\s*:`)
	armRegexResources                               = regexp.MustCompile(`"resources"\s*:`)
	cloudRegex                                      = regexp.MustCompile(`"?Resources"?\s*:`)
	k8sRegex                                        = regexp.MustCompile(`"?apiVersion"?\s*:`)
	k8sRegexKind                                    = regexp.MustCompile(`"?kind"?\s*:`)
	...
	artifactsRegexKind                              = regexp.MustCompile(`"?kind"?\s*:`)
	artifactsRegexProperties                        = regexp.MustCompile(`"?properties"?\s*:`)
	artifactsRegexParametes                         = regexp.MustCompile(`"?parameters"?\s*:`)
	policyAssignmentArtifactRegexPolicyDefinitionID = regexp.MustCompile(`"?policyDefinitionId"?\s*:`)
	roleAssignmentArtifactRegexPrincipalIds         = regexp.MustCompile(`"?principalIds"?\s*:`)
	roleAssignmentArtifactRegexRoleDefinitionID     = regexp.MustCompile(`"?roleDefinitionId"?\s*:`)
	templateArtifactRegexParametes                  = regexp.MustCompile(`"?template"?\s*:`)
	blueprintpRegexTargetScope                      = regexp.MustCompile(`"?targetScope"?\s*:`)
	blueprintpRegexProperties                       = regexp.MustCompile(`"?properties"?\s*:`)
